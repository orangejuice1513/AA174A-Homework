...
class AStar(object):
    ...
    def distance(self, x1, x2):
        ...
        """
        ########## Code starts here ##########
        return np.sqrt ( (x1[0] - x2[0] ) ** 2 + (x1[1] - x2[1]) ** 2 ) # use pythagorean theorem 
        ########## Code ends here ##########
    ...
    def solve(self):
        ...
        while len(self.open_set) > 0: 
            ...
            for neighbor in self.get_neighbors(x_cur): # explore all the neighbors
                ...
                if neighbor not in self.open_set:
                    ...
                    continue #skip neighbors that have higher cost to arrive thru x_cur 
                # if not, select this neighbor 
                self.came_from[neighbor] = x_cur
        ...
        return False # if the search reaches this point, there is no valid path   
        ########## Code ends here ##########
